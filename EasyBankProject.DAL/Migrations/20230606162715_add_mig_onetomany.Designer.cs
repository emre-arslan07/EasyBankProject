...
{
    [DbContext(typeof(EasyBankProjectDbContext))]
    [Migration("20230606162715_add_mig_onetomany")]
    partial class add_mig_onetomany
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasyBankProject.ENTITY.Concrete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EasyBankProject.ENTITY.Concrete.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EasyBankProject.ENTITY.Concrete.CustomerAccount", b =>
                {
            ...
            modelBuilder.Entity("EasyBankProject.ENTITY.Concrete.CustomerAccountProcess", b =>
                {
            ...
            modelBuilder.Entity("EasyBankProject.ENTITY.Concrete.CustomerAccount", b =>
                {
                    b.HasOne("EasyBankProject.ENTITY.Concrete.AppUser", null)
            ...
            modelBuilder.Entity("EasyBankProject.ENTITY.Concrete.CustomerAccountProcess", b =>
                {
                    b.HasOne("EasyBankProject.ENTITY.Concrete.CustomerAccount", "ReceiverCustomer")
                        .WithMany("CustomerReceiver")
                        .HasForeignKey("ReceiverID");

                    b.HasOne("EasyBankProject.ENTITY.Concrete.CustomerAccount", "SenderCustomer")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("EasyBankProject.ENTITY.Concrete.AppRole", null)
                        .WithMany()
